        ...
        <div class="row">
            ...
            <div class="col-xs-6">
                ...
                <hr>
                        ...
                        <div class="row">
                            <div class="col-xs-2"><h4>Broj dana:</h4></div>
                            <div class="col-xs-2"
                        ...
                        <div class="row">
                            <div class="col-xs-10"><h2>Ukupno: <span id="total-product-price"
                                                                    value="{{$price->price}}"></span></h2></div>
                        </div>
                        <div class="row">
                            <div class="col-xs-5">
                                <button product-id='{{$product->id}}' id='add_to_cart' class="btn btn-default">Dodaj u korpu
                                </button>
                            </div>
                        </div>
                    </div>
